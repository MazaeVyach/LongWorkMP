...
namespace Alphabet.Tests
{
    ...
    public class DefineRangeTests
    {
        ...
        {
            Assert.That(() => myAlph.DefineRange(-15),
                Throws.TypeOf<ApplicationException>().
                    With.Message.EqualTo("Число вне диапазона!"));

            Assert.Throws<ApplicationException>(() => myAlph.DefineRange(-15));


            Assert.That(() => myAlph.DefineRange(4432676798592),
                Throws.TypeOf<ApplicationException>().
                    With.Message.EqualTo("Число вне диапазона!"));

            Assert.Throws<ApplicationException>(() => myAlph.DefineRange(4432676798592));
        }
        ...
        {
            int range = myAlph.DefineRange(126);
        ...
        {
            int range = myAlph.DefineRange(16511);
        ...
        {
            int range = myAlph.DefineRange(16514);
        ...
        {
            int range = myAlph.DefineRange(270549110);
        ...
        {
            int range = myAlph.DefineRange(270549130);
        ...
        {
            int range = myAlph.DefineRange(34630287489);
